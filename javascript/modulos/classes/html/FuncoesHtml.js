...
class FuncoesDropdown{
    ...
    static getInstance(){
        if (FuncoesDropdown.#instance == null) {
            FuncoesDropdown.#instance = new FuncoesDropdown();            
        }
        return FuncoesDropdown.#instance;
    }
...
class FuncoesComboboxs{
    ...
    static getInstance(){
        if (FuncoesComboboxs.#instance == null) {
            FuncoesComboboxs.#instance = new FuncoesComboboxs();
        }
        return FuncoesComboboxs.#instance;
    }
...
class FuncoesCalendario{
    ...
    static getInstance(){
        if (FuncoesCalendario.#instance == null) {
            FuncoesCalendario.#instance = new FuncoesCalendario();
        }
        return FuncoesCalendario.#instance;
    }
...
class FuncoesTabDados{
    ...
    static getInstance(){
        if (FuncoesTabDados.#instance == null) {
            FuncoesTabDados.#instance = new FuncoesTabDados();
        }
        return FuncoesTabDados.#instance;
    }
...
class FuncoesBootStrap{
    ...
    static getInstance(){
        if (FuncoesBootStrap.#instance == null) {
            FuncoesBootStrap.#instance = new FuncoesBootStrap();
        }
        return FuncoesBootStrap.#instance;
    }
...
class FuncoesHtml{
    ...
    static getInstance(){
        if (FuncoesHtml.#instance == null) {
            FuncoesHtml.#instance = new FuncoesHtml();
            window.fnhtml = FuncoesHtml.#instance;
        }
        return FuncoesHtml.#instance;
    }
    ...
    constructor(){
        try {
            ...
            this.fndrop = FuncoesDropdown.getInstance();
            this.fncomboboxs = FuncoesComboboxs.getInstance();
            this.fncal = FuncoesCalendario.getInstance();
            this.fntabdados = FuncoesTabDados.getInstance();
            this.btstrp = FuncoesBootStrap.getInstance();
            fnjs.logf(this.constructor.name);
            fnjs.logf(this.constructor.name);
        } catch(erro) {
            console.log(erro);
...
export default FuncoesHtml.getInstance(); 