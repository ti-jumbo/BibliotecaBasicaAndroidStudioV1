...
<head>
    ...
    <title>SisJD - Alterar Pedidos</title>
                ...
                <div name="div_pagina" class="div_pagina container-fluid" style="width: 100%; min-width: 100%; inset: 50px 0px 0px;">
                    <div name="div_grid_linha_corpo_pagina" class="row">
                        <div name="div_grid_col_corpo_pagina" class="col">
                            <div name="div_conteudo_pagina" class="div_conteudo_pagina container-fluid _0_034026538962064756 _0_9271250652875438">
                                <div></div>
                                <div name="div_alterar_pedido" class="div_alterar_pedido container-fluid corpo-conteudo" ajuda_elemento="ltere o(s) pedido(s) selecionado(s). " data-tit_aba="div_alterar_pedido" data-nome="div_alterar_pedido">
                                                ...
                                                <div id="painel_div_opcoes_pesquisa_corpo" class="collapse show">
                                                    <div class="accordion-body" aberto="1">
                                                        ...
                                                        <div class="div_opcoes_pesquisa_simples_col col">
                                                            ...
                                                            <div class="div_botao_pesquisar d-grid gap-2 col-6 mx-auto mt-3"><button class="botao_pesquisar btn btn-primary" value="Pesquisar" data-visao="altera_pedido" onclick="window.fnsisjd.pesquisar_dados(this)">Pesquisar</button></div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
