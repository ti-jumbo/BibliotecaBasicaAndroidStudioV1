<?php
    ...
    //include_once($_SERVER['DOCUMENT_ROOT']."/SJD2/php/initial_loads.php"); erro: redirecionamento recursivo
...
<head>
    ...
    <title>SisJD2 - Login</title>
    <link href="/bootstrap/5.1.3/css/bootstrap.min.css" rel="stylesheet">
    <link href="/sjd2/css/login.css" rel="stylesheet">
    <script type="text/javascript" src="/bootstrap/5.1.3/js/bootstrap.bundle.min.js"></script>
    <script type="module" src="/sjd2/javascript/modulos/ModuloPrincipal.js?1.00"></script>
</head>
<body>
    <main name="main_login" class="main_login form-signin">
        <form name="form_login" class="form_login" onsubmit="window.fnsisjd.requisitar_login({elemento:this});return false;">
            <img name="img_login_logo" class="mb-4 rounded" src="/sjd2/images/logo_login.png">
            <h1 name="login_titulo" class="h3 mb-3 fw-normal">Login SISJD2</h1>
