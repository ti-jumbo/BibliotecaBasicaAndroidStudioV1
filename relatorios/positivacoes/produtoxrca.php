...
<head>
    ...
    <title>SisJD - Positicacao Produto x Rca</title>
                ...
                <div name="div_pagina" class="div_pagina container-fluid" style="width: 100%; min-width: 100%; inset: 50px 0px 0px;">
                    <div name="div_grid_linha_corpo_pagina" class="row">
                        <div name="div_grid_col_corpo_pagina" class="col">
                            <div name="div_conteudo_pagina" class="div_conteudo_pagina container-fluid _0_003271750417522923 _0_4874174923634592">
                                <div></div>
                                <div name="div_produtoxrca" class="div_produtoxrca container-fluid corpo-conteudo" ajuda_elemento="eja o cruzamento das vendas de produto x rca. " data-tit_aba="Produto x RCA" data-nome="aba_produtoxrca">
                                            ...
                                            <div id="painel_div_opcoes_pesquisa_corpo" class="collapse show">
                                                <div class="accordion-body" aberto="1">
                                                    <div class="div_opcoes_pesquisa_simples row">
                                                                                    ...
                                                                                    <div class="col">
                                                                                        <div class="row">
                                                                                            <div class="col-auto col">
                                                                                                <input type="date" class="componente_data">
                                                                                            </div>
                                                                                            <div class="col-auto col">
                                                                                                <input type="date" class="componente_data">
                                                                                            </div>
                                                                        ...
                                                                        <div class="div_opcoes_pesquisa_avancada_col col">
                                                                            <div class="accordion">
                                                                                ...
                                                                                <div id="painel_ver_vals_de" class="collapse">
                                                                                    <div class="accordion-body">
                                                                                        <div class="row">
                                                                                            <div class="col"><label class="rotulo_ver_vals_de width_33pc" textodepois="1"><input type="radio" class="radio_ver_valores_de" value="0" name="radio_ver_vals_de_posit_prodxrca">Qtde</label><label class="rotulo_ver_vals_de width_33pc" textodepois="1"><input type="radio" class="radio_ver_valores_de" value="3" name="radio_ver_vals_de_posit_prodxrca" checked="true">Peso Total</label><label class="rotulo_ver_vals_de width_33pc" textodepois="1"><input type="radio" class="radio_ver_valores_de" value="5" name="radio_ver_vals_de_posit_prodxrca">Valor Total</label></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                </div>
                                                                                ...
                                                                                <div id="painel_ver_vals_zero" class="collapse">
                                                                                    <div class="accordion-body">
                                                                                        <div class="row">
                                                                                            <div class="col"><label class="rotulo_ver_valores_zero1" textodepois="1"><input type="radio" class="radio_ver_valores_de" value="0" name="radio_ver_vals_zero_posit_produtoxrca">Mostrar como Zero</label><label class="rotulo_ver_valores_zero1" textodepois="1"><input type="radio" class="radio_ver_valores_de" value="1" name="radio_ver_vals_zero_posit_produtoxrca" checked="true">Mostra em branco</label></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                </div>
                                                        ...
                                                        <div class="div_botao_pesquisar d-grid gap-2 col-6 mx-auto mt-3"><button class="botao_pesquisar btn btn-primary" value="Pesquisar" data-visao="produtoxrca" onclick="window.fnsisjd.pesquisar_dados(this)">Pesquisar</button></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
