...
<head>
    ...
    <title>SisJD - Produtos nao positivados</title>
                ...
                <div name="div_pagina" class="div_pagina container-fluid" style="width: 100%; min-width: 100%; inset: 50px 0px 0px;">
                    <div name="div_grid_linha_corpo_pagina" class="row">
                        <div name="div_grid_col_corpo_pagina" class="col">
                            <div name="div_conteudo_pagina" class="div_conteudo_pagina container-fluid _0_553287574742289 _0_16288556229840667">
                                <div></div>
                                <div name="div_produtosnaopositivados" class="div_produtosnaopositivados container-fluid corpo-conteudo" ajuda_elemento="Veja os produtos que foram vendidos em um periodo e em outro nao, ex: mes passado e esse mes." data-tit_aba="produtosnaopositivados" data-nome="produtosnaopositivados">
                                            ...
                                            <div id="painel_div_opcoes_pesquisa_corpo" class="collapse show">
                                                <div class="accordion-body" aberto="1">
                                                    <div class="div_opcoes_pesquisa_simples row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-auto mt-2 div_visao col">
                                                                            <div permite_incluir="1" funcao_inclusao="window.fnsisjd.inserir_visao_pesquisa({elemento:this})" funcao_exclusao="window.fnsisjd.deletar_controles({elemento:this})" class="card">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col">
                                                                                        <div label="Visao 01" class="desabilitado div_combobox" tem_inputs="1" tipo_inputs="radio" multiplo="0" selecionar_todos="0" filtro="1" classe_botao="btn-dark" classe_dropdown="dropdown-visao " placeholder="(Selecione)" name_inpus="_612676800" num_max_texto_botao="5" funcao_filtro="window.fnhtml.fndrop.filtrar_dropdown(this)">
                                                                                            ...
                                                                                            <li opcoes_texto_opcao="Origem de Dados" opcoes_texto_botao="Origem de Dados" opcoes_valor_opcao="Origem de Dados" class="dropdown-item li" data-valor_opcao="Origem de Dados" data-texto_botao="Origem de Dados"><label textodepois="1"><input type="radio" name="_612676800">Origem de Dados</label></li>
                                                                                            <li opcoes_texto_opcao="Empresa" opcoes_texto_botao="Empresa" opcoes_valor_opcao="Empresa" class="dropdown-item li" data-valor_opcao="Empresa" data-texto_botao="Empresa"><label textodepois="1"><input type="radio" name="_612676800">Empresa</label></li>
                                                                                            <li opcoes_texto_opcao="Filial" opcoes_texto_botao="Filial" opcoes_valor_opcao="Filial" class="dropdown-item li" data-valor_opcao="Filial" data-texto_botao="Filial"><label textodepois="1"><input type="radio" name="_612676800">Filial</label></li>
                                                                                            <li opcoes_texto_opcao="Fornecedor" opcoes_texto_botao="Fornecedor" opcoes_valor_opcao="Fornecedor" class="dropdown-item li" data-valor_opcao="Fornecedor" data-texto_botao="Fornecedor"><label textodepois="1"><input type="radio" name="_612676800">Fornecedor</label></li>
                                                                                            <li opcoes_texto_opcao="Cidade" opcoes_texto_botao="Cidade" opcoes_valor_opcao="Cidade" class="dropdown-item li" data-valor_opcao="Cidade" data-texto_botao="Cidade"><label textodepois="1"><input type="radio" name="_612676800">Cidade</label></li>
                                                                                            <li opcoes_texto_opcao="Supervisor" opcoes_texto_botao="Supervisor" opcoes_valor_opcao="Supervisor" class="dropdown-item li" data-valor_opcao="Supervisor" data-texto_botao="Supervisor"><label textodepois="1"><input type="radio" name="_612676800">Supervisor</label></li>
                                                                                            <li opcoes_texto_opcao="Rca" opcoes_texto_botao="Rca" opcoes_valor_opcao="Rca" class="dropdown-item li" data-valor_opcao="Rca" data-texto_botao="Rca"><label textodepois="1"><input type="radio" name="_612676800">Rca</label></li>
                                                                                            <li opcoes_texto_opcao="Ramo de Atividade" opcoes_texto_botao="Ramo de Atividade" opcoes_valor_opcao="Ramo de Atividade" class="dropdown-item li" data-valor_opcao="Ramo de Atividade" data-texto_botao="Ramo de Atividade"><label textodepois="1"><input type="radio" name="_612676800">Ramo de Atividade</label></li>
                                                                                            <li opcoes_texto_opcao="Departamento" opcoes_texto_botao="Departamento" opcoes_valor_opcao="Departamento" class="dropdown-item li" data-valor_opcao="Departamento" data-texto_botao="Departamento"><label textodepois="1"><input type="radio" name="_612676800">Departamento</label></li>
                                                                                            <li opcoes_texto_opcao="Produto" opcoes_texto_botao="Produto" opcoes_valor_opcao="Produto" class="dropdown-item li" data-valor_opcao="Produto" data-texto_botao="Produto"><label textodepois="1"><input type="radio" name="_612676800" checked="1">Produto</label></li>
                                                                                            <li opcoes_texto_opcao="Evolucao" opcoes_texto_botao="Evolucao" opcoes_valor_opcao="Evolucao" class="dropdown-item li" data-valor_opcao="Evolucao" data-texto_botao="Evolucao"><label textodepois="1"><input type="radio" name="_612676800">Evolucao</label></li>
                                                                                            <li opcoes_texto_opcao="Cliente" opcoes_texto_botao="Cliente" opcoes_valor_opcao="Cliente" class="dropdown-item li" data-valor_opcao="Cliente" data-texto_botao="Cliente"><label textodepois="1"><input type="radio" name="_612676800">Cliente</label></li>
                                                                                            <li opcoes_texto_opcao="Nota Fiscal" opcoes_texto_botao="Nota Fiscal" opcoes_valor_opcao="Nota Fiscal" class="dropdown-item li" data-valor_opcao="Nota Fiscal" data-texto_botao="Nota Fiscal"><label textodepois="1"><input type="radio" name="_612676800">Nota Fiscal</label></li>
                                                                                            <li opcoes_texto_opcao="Item de Nota Fiscal" opcoes_texto_botao="Item de Nota Fiscal" opcoes_valor_opcao="Item de Nota Fiscal" class="dropdown-item li" data-valor_opcao="Item de Nota Fiscal" data-texto_botao="Item de Nota Fiscal"><label textodepois="1"><input type="radio" name="_612676800">Item de Nota Fiscal</label></li>
                                                                                            <li opcoes_texto_opcao="Rota" opcoes_texto_botao="Rota" opcoes_valor_opcao="Rota" class="dropdown-item li" data-valor_opcao="Rota" data-texto_botao="Rota"><label textodepois="1"><input type="radio" name="_612676800">Rota</label></li>
                                                                                            <li opcoes_texto_opcao="Praca" opcoes_texto_botao="Praca" opcoes_valor_opcao="Praca" class="dropdown-item li" data-valor_opcao="Praca" data-texto_botao="Praca"><label textodepois="1"><input type="radio" name="_612676800">Praca</label></li>
                                                                                            <li opcoes_texto_opcao="Negocio Aurora" opcoes_texto_botao="Negocio Aurora" opcoes_valor_opcao="Negocio Aurora" class="dropdown-item li" data-valor_opcao="Negocio Aurora" data-texto_botao="Negocio Aurora"><label textodepois="1"><input type="radio" name="_612676800">Negocio Aurora</label></li>
                                                                                            <li opcoes_texto_opcao="Categoria Aurora" opcoes_texto_botao="Categoria Aurora" opcoes_valor_opcao="Categoria Aurora" class="dropdown-item li" data-valor_opcao="Categoria Aurora" data-texto_botao="Categoria Aurora"><label textodepois="1"><input type="radio" name="_612676800">Categoria Aurora</label></li>
                                                                                            <li opcoes_texto_opcao="Rede de clientes" opcoes_texto_botao="Rede de clientes" opcoes_valor_opcao="Rede de clientes" class="dropdown-item li" data-valor_opcao="Rede de clientes" data-texto_botao="Rede de clientes"><label textodepois="1"><input type="radio" name="_612676800">Rede de clientes</label></li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <div class="div_botao_pesquisar d-grid gap-2 col-6 mx-auto mt-3"><button class="botao_pesquisar btn btn-primary" value="Pesquisar" data-visao="produtosnaopositivados" onclick="window.fnsisjd.pesquisar_dados(this)">Pesquisar</button></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
