...
class AccordionHeaderConsiderarValsDe extends AccordionHeader{
    private static string $defaultTitle = 'Considerar Valores De (Vendas normais, devoluções, bonificações)';
    private static string $defaultTarget = '#painel_considerar_vals_de';
