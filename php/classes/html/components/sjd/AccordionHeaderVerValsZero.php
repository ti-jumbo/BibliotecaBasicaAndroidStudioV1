...
class AccordionHeaderVerValsZero extends AccordionHeader{
    private static string $defaultTitle = 'Ver Valores Zero como';
    private static string $defaultTarget = '#painel_ver_vals_zero';
