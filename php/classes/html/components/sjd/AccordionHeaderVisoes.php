...
class AccordionHeaderVisoes extends AccordionHeader{
    private static string $defaultTitle = 'Visualizar (Colunas de Dados)';
    private static string $defaultTarget = '#visoes';
