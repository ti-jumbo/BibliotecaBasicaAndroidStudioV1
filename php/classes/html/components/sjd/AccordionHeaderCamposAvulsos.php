...
class AccordionHeaderCamposAvulsos extends AccordionHeader{
    private static string $defaultTitle = 'Campos Avulsos';
    private static string $defaultTarget = '#painel_campos_avulsos';
