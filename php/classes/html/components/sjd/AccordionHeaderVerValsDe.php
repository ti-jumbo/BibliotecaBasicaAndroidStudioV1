...
class AccordionHeaderVerValsDe extends AccordionHeader{
    private static string $defaultTitle = 'Ver Valores de (Unidades)';
    private static string $defaultTarget = '#painel_ver_vals_de';
