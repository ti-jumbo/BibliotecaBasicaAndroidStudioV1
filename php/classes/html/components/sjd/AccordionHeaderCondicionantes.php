...
class AccordionHeaderCondicionantes extends AccordionHeader{
    private static string $defaultTitle = 'Condicionantes';
    private static string $defaultTarget = '#painel_condicionantes';
