			...
			switch($params['tipoelemento']){
				...
				default:					
					...
					if (method_exists('\\' . self::getInstancia()->getInstanciaSis()::class,$nome_metodo) || 
						...
						FuncoesBasicasRetorno::mostrar_msg_sair('Erro na requisicao de dados sql: tipo retorno não definido: '.$comhttp->requisicao->requisitar->qual->condicionantes['tipo_retorno'],__FILE__,__FUNCTION__,__LINE__);
					}
					break;
			}
			return $retorno;
