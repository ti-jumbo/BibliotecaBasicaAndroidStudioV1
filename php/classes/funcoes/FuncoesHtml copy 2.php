<?php
	...
	class FuncoesHtml extends ClasseBase{
		...
		public static function inicializar_params_criar_elemento(?array $params = [], ?string $tag, ?string $class) : array {
			$params = $params ?? [];
		...
		public static function criar_elemento(?array $params = [],?string $tag, ?string $class) : array {
		...
		/*public static function montar_combobox(?array $params_combobox=[],?bool $forcar_selecao_por_valores=false):string {
			$params_combobox = self::inicializar_params_criar_elemento($params_combobox,"div","div_combobox");
			...
			if (isset($params_combobox["filtro"]) && in_array($params_combobox["filtro"],Constantes::array_verdade)) {
				$params_combobox["funcao_filtro"] = $params_combobox["funcao_filtro"] ?? "window.fnhtml.fndrop.filtrar_dropdown(this)";
				$params_combobox["sub"][1]["sub"][] = [
					"tag" => "input",
					"type" => "text",
					"class" => "input_filtro_dropdown rounded",
					"placeholder" => "(filtro)",
					"onkeyup" =>$params_combobox["funcao_filtro"]
				];
			}
		...
		public static function montar_card_padrao(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","card");
		...
		public static function montar_card_combobox_visao(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","");
			...
			$params["elementos_body"] = [
				self::criar_row([
					"sub"=>[
						self::criar_col(["text" => $html_combobox])
			...
			return self::montar_card_padrao($params);
		}
		...
		public static function montar_combobox_condicionante(?array $params = []) : string { 
			$params = self::inicializar_params_criar_elemento($params,"div","condicionante");
		 ...
		 * @return {string} - a string html montada
		 */
		public static function montar_comboboxs_condicionante(?array $params = []) : string { 
			$params = $params ?? [];
			...
			$params["sub"][] = [
				...
				"sub" => [
					[
						"tag"=>"div",
						"class" => "col-auto",
						"text" => $html_combobox_visao
					],[
						"tag"=>"div",
						"class" => "col-auto",
						"text" => $html_comparador
					],[
						"tag"=>"div",
						"class" => "col-auto",
						"text" => $html_dados_condicionante
					]
				]
			];
			unset($params["selecionados"]);
		...
		/**
		 * Monta a string html de um card do combo de drop-down3 (bootstrap) de condicionante (visao+operacao+valores)
		 * conforme parametros
		 * @created 30/09/2021
		 * @param {?array} $params - o array com as opcoes para montagem
		 * @return {string} - a string html montada
		 */
		public static function montar_card_comboboxs_condicionante(?array $params = []) : string{
			$params = self::inicializar_params_criar_elemento($params,"div","");
			$params["titulo"] = $params["titulo"] ?? $params["cabecalho"] ?? $params["label"] ?? $params["title"] ?? "";
			$params["funcao_inclusao"] = $params["funcao_inclusao"] ?? "window.fnsisjd.inserir_visao_pesquisa({elemento:this})";
			$params["funcao_exclusao"] = $params["funcao_exclusao"] ?? "window.fnsisjd.deletar_controles({elemento:this})";
				...
				[
					...
					"sub"=>[
						[
							"tag"=>"div",
							"class"=>"col",
							"text" => $html_comboboxs_condicionantes
						],
						$params["params_botoes_controle"]
					]
				]
		...
		/**
		 * Monta a string html de um array cards do combo de drop-down3 (bootstrap) de condicionante (visao+operacao+valores)
		 * conforme parametros
		 * @created 30/09/2021
		 * @param {?array} $params - o array com as opcoes para montagem
		 * @return {string} - a string html montada
		 */
		public static function montar_cards_comboboxs_condicionante(?array $params = []) : string {
			$retorno = [];
			$params = $params ?? [];
			...
			foreach($params["itens"] as $iten){								
				...
				//print_r($iten); exit();
				$retorno[] = self::montar_card_comboboxs_condicionante($iten);
				$ind++;
			}
			return implode("",$retorno);
		}
		 ...
		 * @return {string} - a string html montada
		 */
		public static function montar_card_combobox_campo_avulso(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","");
			$params["titulo"] = $params["titulo"] ?? $params["cabecalho"] ?? $params["label"] ?? $params["title"] ?? "";
			self::setar_propriedades_padrao_controles($params);
			...
			$html_combobox = self::montar_combobox_campos_avulsos($params["params_combobox"]);						
			$params["elementos_body"] = [
				[
					"tag"=>"div",
					"class"=>"row",
		 ...
		 * @return {string} - a string html montada
		 */
		public static function montar_cards_combobox_campo_avulso(?array $params = []) : string {
			$retorno = [];
			$params = $params ?? [];
			$params["itens"] = $params["itens"] ?? [];
			$params["permite_incluir"] = $params["permite_incluir"] ?? false;
			...
			foreach($params["itens"] as $iten){
				...
				$retorno[] = self::montar_card_combobox_campo_avulso([
					"sup"=>[
						[
							"tag"=>"div",
							"class"=>"col-auto mt-2 div_visao"
		...
		public static function montar_div_resultado_padrao(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","div_resultado_l2 row ");
			$params["sub"][] = [
				"tag" => "div",
		...
		public static function montar_accordion_button(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","accordion-button");
		...
		public static function montar_accordion_header(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","accordion-header");
			...
			$params["text"] = self::montar_accordion_button($params_button);
			unset($params["params_button"]);
			return self::montar_elemento_html($params);
		}

		public static function montar_accordion_body(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","accordion-body");
			return self::montar_elemento_html($params);
		}

		public static function montar_accordion_body_sisjd(?array $params = []) : string {
			$params = self::inicializar_params_criar_elemento($params,"div","accordion-body");			
			...
			$retorno .= '</div>';*/
			$params["permite_incluir"] = $params["permite_incluir"] ?? false;
			if (FuncoesConversao::como_boleano($params["permite_incluir"]) === true) {
				...
				$retorno .= '<div class="div_opcoes_pesquisa col m-1">';
					$retorno .= '<div class="accordion">';
						...
						$retorno .= '<div class="accordion-item">';
							$retorno .= self::montar_accordion_header([
																			...
																			$retorno .= '<div class="accordion-item">';
																				...
																				$retorno .= '<div id="painel_condicionantes" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">';
																					$retorno .= '<div class="accordion-body">';
																						...
																						$retorno .= '<div class="row">';
																							$retorno .= self::montar_cards_comboboxs_condicionante($opcoes["avancado"]["condicionantes"]);	
																						$retorno .= '</div>';
																					$retorno .= '</div>';
																				$retorno .= '</div>';
																			$retorno .= '</div>';
																		...
																		if ($opcoes["avancado"]["campos_avulsos"]["ativo"] === true) {
																			...
																			$retorno .= '<div class="accordion-item">';
																				...
																				$retorno .= '<div id="painel_campos_avulsos" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">';
																					$retorno .= '<div class="accordion-body">';
																						$retorno .= '<div class="row">';
																							$retorno .= self::montar_cards_combobox_campo_avulso($opcoes["avancado"]["campos_avulsos"]);
																						$retorno .= '</div>';
																					$retorno .= '</div>';
																				$retorno .= '</div>';
																			$retorno .= '</div>';																					
		...
		public static function montar_elemento_html_sisjd(?array $params = []) : string{
			...
			switch($params["tipoelemento"]){
				case "comboboxes_condicionante":
					...
					//print_r($params); exit();
					$retorno = self::montar_elemento_html([
						"tag"=>"div",
						"class"=>"row",
						"text" => self::montar_cards_comboboxs_condicionante($params)
					]);
					break;						
